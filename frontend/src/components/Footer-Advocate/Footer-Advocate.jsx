...
export default function AdvocateFooter() {
            ...
            <div className="max-w-7xl mx-auto px-6 py-14 grid md:grid-cols-4 gap-10">
                ...
                <div>
                    ...
                    <p className="mt-5 text-slate-400 leading-7">
                        Empowering advocates with modern legal technology.
                        Manage consultation requests, communicate with clients,
                        and deliver justice efficiently through one platform.
                    </p>
            ...
            <div className="border-t border-white/10">
                ...
                <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center">
                    ...
                    <p className="text-slate-500 text-sm mt-3 md:mt-0">
                        Empowering Advocates with AI • Built for Digital Justice 🇮🇳
                    </p>
